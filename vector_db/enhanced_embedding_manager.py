# vector_db/enhanced_embedding_manager.py
...
class EnhancedEmbeddingManager:
    ...
    async def migrate_from_old_model(
        ...
        try:
            ...
            logger.info(f"Starting migration from {old_manager.model_name} to {self.model_info['model_name']}")
            ...
            results["statistics"] = {
                ...
                "old_model": old_manager.model_name,
                "new_model": self.model_info["model_name"],
                "old_dimension": getattr(old_manager, 'embedding_dim', 768),

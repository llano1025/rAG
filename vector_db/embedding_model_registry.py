    ...
    def _load_default_models(self):
        ...
        default_models = [
            ...
            ModelMetadata(
                ...
                use_cases=["multilingual", "semantic_search", "retrieval"],
                language_support=["en", "es", "fr", "de", "it", "zh", "ja", "ko"],
                model_size_mb=1340,
                quality_score=0.92,
            ...
            ModelMetadata(
                model_id="hf-bge-large",
                provider=EmbeddingProvider.HUGGINGFACE,
                model_name="BAAI/bge-large-en-v1.5",
                display_name="BGE Large EN v1.5",
                description="State-of-the-art English embedding model for high accuracy",
                embedding_dimension=1024,
                max_input_length=512,
                performance_tier="quality",
                use_cases=["english", "semantic_search", "retrieval", "rag"],
                language_support=["en"],
                model_size_mb=1340,
                quality_score=0.95,
                memory_requirements_mb=4096,
